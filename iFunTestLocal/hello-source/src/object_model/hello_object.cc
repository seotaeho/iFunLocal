...
CsApiHandler::CsApiHandler() : schemas_(boost::assign::map_list_of
    ...
    ("User", "{\"User\": {\"propertylist\": [{\"readonly\": true, \"type\": \"string\", \"name\": \"Id\", \"key\": true}, {\"type\": \"object\", \"name\": \"MyCharacter\", \"schema\": \"Character\"}], \"type\": \"object\"}}").convert_to_container<boost::unordered_map<string, string> >()),
...
// Character dumper
void DumpJson(hello::Character &obj, Json &out) {
...
// User dumper
void DumpJson(hello::User &obj, Json &out) {
